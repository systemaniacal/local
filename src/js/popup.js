...
function getBackgroundState (state = undefined, callback) {
  chrome.runtime.sendMessage({'msg': 'getState'}, function(response) {
    ...
    if (state && state.curNavLocation) {
      curNavLocation = state.curNavLocation
    } else {
...
function setBackgroundState (callback) {
  var state = {
    loggedIn: loggedIn,
...
getBackgroundState(null, () => {
  ...
  document.getElementById('homeNav').addEventListener('click', () => {
    getBackgroundState({curNavLocation: 'Home'}, () => {
      if (!loggedIn) {
        // document.getElementById("loginNav").innerHTML = 'Login'
        document.getElementById('content').innerHTML = loginHtml
        addLoginButtonEvent()
  ...
  document.getElementById('sendNav').addEventListener('click', () => {
    getBackgroundState({curNavLocation: 'Send'}, () => {
  ...
  document.getElementById('testInvokeNav').addEventListener('click', () => {
    getBackgroundState({curNavLocation: 'Test Invoke Contract'}, () => {
  ...
  document.getElementById('sendInvokeNav').addEventListener('click', () => {
    getBackgroundState({curNavLocation: 'Send Invoke Contract'}, () => {
  ...
  document.getElementById('txsNav').addEventListener('click', () => {
    ...
    getBackgroundState({curNavLocation: 'Transactions'}, () => {
      console.log(curNavLocation)
  ...
  document.getElementById('balanceNav').addEventListener('click', () => {
    ...
    getBackgroundState({curNavLocation: 'Balance'}, () => {
  ...
  document.getElementById('createWalletNav').addEventListener('click', () => {
    ...
    getBackgroundState({curNavLocation: 'Create Wallet'}, () => {
  ...
  document.getElementById('importWalletNav').addEventListener('click', () => {
    ...
    getBackgroundState({curNavLocation: 'Import Wallet'}, () => {
  ...
  document.getElementById('exportWalletNav').addEventListener('click', () => {
    ...
    getBackgroundState({curNavLocation: 'Export Wallet'}, () => {
  ...
  document.getElementById('configNav').addEventListener('click', () => {
    ...
    getBackgroundState({curNavLocation: 'Config'}, () => {
